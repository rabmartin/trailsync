...
export default function TrailSync() {
  ...
  setAuthState("login");
      ...
      <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 60, display: "flex", alignItems: "center", justifyContent: "space-around", alignItems: "flex-end", padding: "2px 6px 2px", borderTop: "1px solid rgba(90,152,227,0.1)", background: "rgba(4,30,61,.96)", backdropFilter: "blur(12px)" }}>
        {tabs.map((t, i) => {
