  ...
  return (
    ...
    <div style={{ padding: "0 16px 16px", overflowY: "auto", flex: 1 }}>
      ...
      <div style={{ display: "flex", gap: "3px", marginBottom: "14px", background: "#0a2240", borderRadius: "12px", padding: "3px", overflowX: "auto" }}>
        {[["mountains", "Mountains"], ["posts", "Posts"], ["stats", "Stats"], ["leaderboard", "Leaderboard"], ["badges", "Badges"]].map(([k, l]) => <button key={k} onClick={() => handleSecChange(k)} style={{ flex: 1, padding: "8px", borderRadius: "10px", border: "none", background: sec === k ? "rgba(90,152,227,0.2)" : "transparent", color: sec === k ? "#5A98E3" : "#BDD6F4", fontSize: "10px", fontWeight: 700, cursor: "pointer", fontFamily: "'DM Sans'", opacity: sec === k ? 1 : 0.5, whiteSpace: "nowrap" }}>{l}</button>)}
      </div>
